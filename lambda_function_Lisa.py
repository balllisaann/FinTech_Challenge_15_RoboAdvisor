...
def get_investment_percentage(risk_level):
    """
    ...
    if age is not None:
        if age <= 0 or age >= 65:
            return build_validation_result(
                False,
                age,
                "You need to be older than 0 and less that 65 to use this service. "
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                investment_amount,
                "You need to invest $5,000 or more. "
                "Please invest $5,000 or more.",
            )
...
def recommend_portfolio(intent_request):
    ...
    # Explicitly parse age as float
 #   age = float(age)
    
    # Explicitly parse risk_level as string and make it lowercase
    ...
    # Get the investment percentage ratio based off of the client's risk_level.
    investment_percentage = get_investment_percentage(risk_level)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you {}.  You have selected a risk level of {},
            so we will make this investment: {}.
            """.format(
                first_name, risk_level, investment_percentage
            ),
        },
    )
